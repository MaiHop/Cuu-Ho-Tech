...
import com.example.cuu_ho_tech.databinding.ActivityRequestEmergencyBinding;
...
public class RequestEmergencyActivity extends AppCompatActivity {
    ActivityRequestEmergencyBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRequestEmergencyBinding.inflate(getLayoutInflater());
    ...
    private void setupBottomSheet() {
        ...
        binding.llTechinicianIsComing.btnTechnicianIsComClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bsb_tech_is_coming.setHideable(false);
                Toast.makeText(RequestEmergencyActivity.this,"OKOK",Toast.LENGTH_SHORT).show();
                bsb_tech_is_coming.setState(BottomSheetBehavior.STATE_COLLAPSED);
            }
        });
    }

    private void toEmergencyMode() {
        binding.llTechinicianIsComing.tvTechinicianIsComingTitle.setTextColor(ContextCompat.getColor(RequestEmergencyActivity.this, R.color.danger_main));
        //Button close
        binding.llTechinicianIsComing.btnTechnicianIsComClose.setBackgroundResource(R.drawable.button_danger_outline_enabled);
        binding.llTechinicianIsComing.btnTechnicianIsComClose.setColorFilter(ContextCompat.getColor(RequestEmergencyActivity.this, R.color.danger_main));

        //Button nhắn tin
        binding.llTechinicianIsComing.btnTechnicianIsComTexting.setBackgroundResource(R.drawable.button_danger_filled_enabled);
        binding.llTechinicianIsComing.btnTechnicianIsComTexting.setColorFilter(ContextCompat.getColor(RequestEmergencyActivity.this, R.color.gray_02_100));

        //Button gọi điện
        binding.llTechinicianIsComing.btnTechnicianIsComPhone.setBackgroundResource(R.drawable.button_danger_filled_enabled);
        binding.llTechinicianIsComing.btnTechnicianIsComPhone.setColorFilter(ContextCompat.getColor(RequestEmergencyActivity.this, R.color.gray_02_100));
    }
