...
public class WalletCashDetailActivity extends AppCompatActivity {
    ActivityWalletCashDetailBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityWalletCashDetailBinding.inflate(getLayoutInflater());
